...
const AssignmentDetailsNavbar = ({ assignmentId, courseId, role }: Props) => {
    ...
    routes.push(
      {
        ...
        route: `/${role.toLowerCase()}/${courseId}/assignments/${assignmentId}`,
      },
      {
        label: 'Submissions',
        route: `/${role.toLowerCase()}/${courseId}/assignments/${assignmentId}/submissions`,
      }
    );
  }
...
export default AssignmentDetailsNavbar;
